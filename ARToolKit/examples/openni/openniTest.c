...
static void draw(ARUint8 *image, ARUint32 *depthBuffer)
{
    ...
    /* set zbuffer from kinect */
    glColorMask(GL_FALSE, GL_FALSE, GL_FALSE, GL_FALSE);
    glDrawPixels(640, 480, GL_DEPTH_COMPONENT, GL_FLOAT, kinectZbuffer);
    ...
    for (y=yres; y>0; y--) {
        for (x=0; x<xres; x++) {
            ...
            if (kd == 0) {
                ...
                z = -1.5833e-14 * kd*kd*kd*kd + 1.1098e-10 * kd*kd*kd - 2.8703e-07 * kd*kd +
                    3.3673e-04 * kd + 8.3245e-01;
                //z = 0.965;
            }
